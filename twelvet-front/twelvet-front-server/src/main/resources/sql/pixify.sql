...
-- ----------------------------
BEGIN;
INSERT INTO `tb_article` (`id`, `user_id`, `category_id`, `article_cover`, `article_title`, `article_content`, `type`, `original_url`, `is_top`, `is_delete`, `status`, `create_time`, `update_time`) VALUES (54, 1, 187, 'https://static.talkxj.com/articles/3dffb2fcbd541886616ab54c92570de3.jpg', '测试文章', '恭喜你成功运行博客，开启你的文章之旅吧。', 1, '', 0, 0, 1, '2022-01-24 23:33:56', NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=858 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of tb_article_tag
-- ----------------------------
BEGIN;
INSERT INTO `tb_article_tag` (`id`, `article_id`, `tag_id`) VALUES (857, 54, 29);
COMMIT;
...
CREATE TABLE `tb_category` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=188 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of tb_category
-- ----------------------------
BEGIN;
INSERT INTO `tb_category` (`id`, `category_name`, `create_time`, `update_time`) VALUES (187, '测试分类', '2022-01-24 23:33:56', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_comment` (`id`, `user_id`, `topic_id`, `comment_content`, `reply_user_id`, `parent_id`, `type`, `is_delete`, `is_review`, `create_time`, `update_time`) VALUES (725, 1, 54, '测试评论', NULL, NULL, 1, 0, 1, '2022-03-11 22:52:24', NULL);
INSERT INTO `tb_comment` (`id`, `user_id`, `topic_id`, `comment_content`, `reply_user_id`, `parent_id`, `type`, `is_delete`, `is_review`, `create_time`, `update_time`) VALUES (726, 1, 54, '测试回复', 1, 725, 1, 0, 1, '2022-03-11 22:52:32', NULL);
INSERT INTO `tb_comment` (`id`, `user_id`, `topic_id`, `comment_content`, `reply_user_id`, `parent_id`, `type`, `is_delete`, `is_review`, `create_time`, `update_time`) VALUES (727, 1, 49, '测试评论', NULL, NULL, 3, 0, 1, '2022-03-11 22:52:41', NULL);
INSERT INTO `tb_comment` (`id`, `user_id`, `topic_id`, `comment_content`, `reply_user_id`, `parent_id`, `type`, `is_delete`, `is_review`, `create_time`, `update_time`) VALUES (728, 1, 49, '测试回复', 1, 727, 3, 0, 1, '2022-03-11 22:52:46', NULL);
INSERT INTO `tb_comment` (`id`, `user_id`, `topic_id`, `comment_content`, `reply_user_id`, `parent_id`, `type`, `is_delete`, `is_review`, `create_time`, `update_time`) VALUES (729, 1, NULL, '测试评论', NULL, NULL, 2, 0, 1, '2022-03-11 22:52:53', NULL);
INSERT INTO `tb_comment` (`id`, `user_id`, `topic_id`, `comment_content`, `reply_user_id`, `parent_id`, `type`, `is_delete`, `is_review`, `create_time`, `update_time`) VALUES (730, 1, NULL, '测试回复', 1, 729, 2, 0, 1, '2022-03-11 22:52:58', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_friend_link` (`id`, `link_name`, `link_avatar`, `link_address`, `link_intro`, `create_time`, `update_time`) VALUES (26, '风丶宇的个人博客', 'https://static.talkxj.com/photos/b553f564f81a80dc338695acb1b475d2.jpg', 'https://www.talkxj.com', '往事不随风', '2022-01-18 00:26:46', NULL);
COMMIT;
...
INSERT INTO `tb_menu` (`id`, `name`, `path`, `component`, `icon`, `create_time`, `update_time`, `order_num`, `parent_id`, `is_hidden`) VALUES (18, '关于我', '/about', '/about/About.vue', 'el-icon-myguanyuwo', '2021-01-26 14:42:05', '2021-01-26 14:42:10', 4, 4, 0);
...
INSERT INTO `tb_menu` (`id`, `name`, `path`, `component`, `icon`, `create_time`, `update_time`, `order_num`, `parent_id`, `is_hidden`) VALUES (213, '权限管理', '/permission-submenu', 'Layout', 'el-icon-mydaohanglantubiao_quanxianguanli', '2021-08-07 19:56:55', '2021-08-07 19:59:40', 4, NULL, 0);
...
INSERT INTO `tb_menu` (`id`, `name`, `path`, `component`, `icon`, `create_time`, `update_time`, `order_num`, `parent_id`, `is_hidden`) VALUES (215, '说说管理', '/talk-submenu', 'Layout', 'el-icon-mypinglun', '2022-01-23 20:17:59', '2022-01-23 20:38:06', 5, NULL, 0);
INSERT INTO `tb_menu` (`id`, `name`, `path`, `component`, `icon`, `create_time`, `update_time`, `order_num`, `parent_id`, `is_hidden`) VALUES (216, '发布说说', '/talks', '/talk/Talk.vue', 'el-icon-myfabusekuai', '2022-01-23 20:18:43', '2022-01-23 20:38:19', 1, 215, 0);
INSERT INTO `tb_menu` (`id`, `name`, `path`, `component`, `icon`, `create_time`, `update_time`, `order_num`, `parent_id`, `is_hidden`) VALUES (217, '说说列表', '/talk-list', '/talk/TalkList.vue', 'el-icon-myiconfontdongtaidianji', '2022-01-23 23:28:24', '2022-01-24 00:02:48', 2, 215, 0);
INSERT INTO `tb_menu` (`id`, `name`, `path`, `component`, `icon`, `create_time`, `update_time`, `order_num`, `parent_id`, `is_hidden`) VALUES (218, '修改说说', '/talks/:talkId', '/talk/Talk.vue', 'el-icon-myshouye', '2022-01-24 00:10:44', NULL, 3, 215, 1);
COMMIT;
...
CREATE TABLE `tb_message` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3939 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of tb_message
-- ----------------------------
BEGIN;
INSERT INTO `tb_message` (`id`, `nickname`, `avatar`, `message_content`, `ip_address`, `ip_source`, `time`, `is_review`, `create_time`, `update_time`) VALUES (3938, '管理员', 'https://static.talkxj.com/avatar/user.png', '测试留言', '127.0.0.1', '', 9, 1, '2022-01-24 23:34:41', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_page` (`id`, `page_name`, `page_label`, `page_cover`, `create_time`, `update_time`) VALUES (1, '首页', 'home', 'https://static.talkxj.com/config/0bee7ba5ac70155766648e14ae2a821f.jpg', '2021-08-07 10:32:36', '2021-12-27 12:19:01');
...
INSERT INTO `tb_page` (`id`, `page_name`, `page_label`, `page_cover`, `create_time`, `update_time`) VALUES (5, '相册', 'album', 'https://static.talkxj.com/config/1ecb6fc94e38c38713000efe37492e73.png', '2021-08-07 10:32:36', '2021-12-27 12:23:12');
...
INSERT INTO `tb_page` (`id`, `page_name`, `page_label`, `page_cover`, `create_time`, `update_time`) VALUES (8, '留言', 'message', 'https://static.talkxj.com/config/acfeab8379508233fa7e4febf90c2f2e.png', '2021-08-07 10:32:36', '2021-10-04 16:11:45');
...
INSERT INTO `tb_page` (`id`, `page_name`, `page_label`, `page_cover`, `create_time`, `update_time`) VALUES (904, '说说', 'talk', 'https://static.talkxj.com/config/a741b0656a9a3db2e2ba5c2f4140eb6c.jpg', '2022-01-23 00:51:24', '2022-01-23 03:01:21');
COMMIT;
...
INSERT INTO `tb_resource` (`id`, `resource_name`, `url`, `request_method`, `parent_id`, `is_anonymous`, `create_time`, `update_time`) VALUES (275, '上传访客信息', '/report', 'POST', 166, 1, '2021-08-24 00:32:05', '2021-08-24 00:32:07');
INSERT INTO `tb_resource` (`id`, `resource_name`, `url`, `request_method`, `parent_id`, `is_anonymous`, `create_time`, `update_time`) VALUES (276, '获取用户区域分布', '/admin/users/area', 'GET', 173, 0, '2021-08-24 00:32:35', '2021-09-24 16:25:34');
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_role` (`id`, `role_name`, `role_label`, `is_disable`, `create_time`, `update_time`) VALUES (1, '管理员', 'admin', 0, '2021-03-22 14:10:21', '2022-01-24 01:32:26');
INSERT INTO `tb_role` (`id`, `role_name`, `role_label`, `is_disable`, `create_time`, `update_time`) VALUES (2, '用户', 'user', 0, '2021-03-22 14:25:25', '2022-01-24 01:32:21');
INSERT INTO `tb_role` (`id`, `role_name`, `role_label`, `is_disable`, `create_time`, `update_time`) VALUES (3, '测试', 'test', 0, '2021-03-22 14:42:23', '2022-01-24 01:32:59');
COMMIT;
...
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2366, 14, 1);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2367, 14, 2);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2461, 1, 1);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2462, 1, 2);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2463, 1, 6);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2464, 1, 7);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2465, 1, 8);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2466, 1, 9);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2467, 1, 10);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2468, 1, 3);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2469, 1, 11);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2470, 1, 12);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2471, 1, 202);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2472, 1, 13);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2473, 1, 201);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2474, 1, 213);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2475, 1, 14);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2476, 1, 15);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2477, 1, 16);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2478, 1, 4);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2479, 1, 214);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2480, 1, 209);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2481, 1, 17);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2482, 1, 18);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2483, 1, 205);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2484, 1, 206);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2485, 1, 208);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2486, 1, 210);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2487, 1, 215);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2488, 1, 216);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2489, 1, 217);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2490, 1, 218);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2491, 1, 19);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2492, 1, 20);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2493, 1, 5);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2494, 3, 1);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2495, 3, 2);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2496, 3, 6);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2497, 3, 7);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2498, 3, 8);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2499, 3, 9);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2500, 3, 10);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2501, 3, 3);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2502, 3, 11);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2503, 3, 12);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2504, 3, 202);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2505, 3, 13);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2506, 3, 201);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2507, 3, 213);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2508, 3, 14);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2509, 3, 15);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2510, 3, 16);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2511, 3, 4);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2512, 3, 214);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2513, 3, 209);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2514, 3, 17);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2515, 3, 18);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2516, 3, 205);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2517, 3, 206);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2518, 3, 208);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2519, 3, 210);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2520, 3, 215);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2521, 3, 216);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2522, 3, 217);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2523, 3, 218);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2524, 3, 19);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2525, 3, 20);
INSERT INTO `tb_role_menu` (`id`, `role_id`, `menu_id`) VALUES (2526, 3, 5);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4750, 14, 238);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4751, 2, 254);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4752, 2, 267);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4753, 2, 269);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4754, 2, 270);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4755, 2, 257);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4756, 2, 258);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4757, 2, 282);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4758, 1, 165);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4759, 1, 192);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4760, 1, 193);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4761, 1, 194);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4762, 1, 195);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4763, 1, 166);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4764, 1, 183);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4765, 1, 184);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4766, 1, 246);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4767, 1, 247);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4768, 1, 167);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4769, 1, 199);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4770, 1, 200);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4771, 1, 201);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4772, 1, 168);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4773, 1, 185);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4774, 1, 186);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4775, 1, 187);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4776, 1, 188);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4777, 1, 189);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4778, 1, 190);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4779, 1, 191);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4780, 1, 254);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4781, 1, 169);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4782, 1, 208);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4783, 1, 209);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4784, 1, 170);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4785, 1, 234);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4786, 1, 235);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4787, 1, 236);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4788, 1, 237);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4789, 1, 171);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4790, 1, 213);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4791, 1, 214);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4792, 1, 215);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4793, 1, 216);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4794, 1, 217);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4795, 1, 224);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4796, 1, 172);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4797, 1, 240);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4798, 1, 241);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4799, 1, 244);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4800, 1, 245);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4801, 1, 267);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4802, 1, 269);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4803, 1, 270);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4804, 1, 173);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4805, 1, 239);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4806, 1, 242);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4807, 1, 276);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4808, 1, 174);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4809, 1, 205);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4810, 1, 206);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4811, 1, 207);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4812, 1, 175);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4813, 1, 218);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4814, 1, 219);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4815, 1, 220);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4816, 1, 221);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4817, 1, 222);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4818, 1, 223);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4819, 1, 176);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4820, 1, 202);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4821, 1, 203);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4822, 1, 204);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4823, 1, 230);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4824, 1, 238);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4825, 1, 177);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4826, 1, 229);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4827, 1, 232);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4828, 1, 233);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4829, 1, 243);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4830, 1, 178);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4831, 1, 196);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4832, 1, 197);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4833, 1, 198);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4834, 1, 257);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4835, 1, 258);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4836, 1, 179);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4837, 1, 225);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4838, 1, 226);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4839, 1, 227);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4840, 1, 228);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4841, 1, 231);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4842, 1, 180);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4843, 1, 210);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4844, 1, 211);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4845, 1, 212);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4846, 1, 278);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4847, 1, 282);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4848, 1, 283);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4849, 1, 284);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4850, 1, 285);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4851, 1, 286);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4852, 1, 287);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4853, 3, 192);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4854, 3, 195);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4855, 3, 183);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4856, 3, 246);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4857, 3, 199);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4858, 3, 185);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4859, 3, 191);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4860, 3, 254);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4861, 3, 208);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4862, 3, 234);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4863, 3, 237);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4864, 3, 213);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4865, 3, 241);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4866, 3, 239);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4867, 3, 276);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4868, 3, 205);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4869, 3, 218);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4870, 3, 221);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4871, 3, 223);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4872, 3, 202);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4873, 3, 230);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4874, 3, 238);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4875, 3, 232);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4876, 3, 243);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4877, 3, 196);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4878, 3, 257);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4879, 3, 258);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4880, 3, 225);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4881, 3, 231);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4882, 3, 210);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4883, 3, 282);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4884, 3, 286);
INSERT INTO `tb_role_resource` (`id`, `role_id`, `resource_id`) VALUES (4885, 3, 287);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_tag` (`id`, `tag_name`, `create_time`, `update_time`) VALUES (29, '测试标签', '2022-01-24 23:33:57', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_user_auth` (`id`, `user_info_id`, `username`, `password`, `login_type`, `ip_address`, `ip_source`, `create_time`, `update_time`, `last_login_time`) VALUES (1, 1, 'admin@qq.com', '$2a$10$AkxkZaqcxEXdiNE1nrgW1.ms3aS9C5ImXMf8swkWUJuFGMqDl.TPW', 1, '127.0.0.1', '', '2021-08-12 15:43:18', '2022-03-11 22:52:18', '2022-03-11 22:52:18');
INSERT INTO `tb_user_auth` (`id`, `user_info_id`, `username`, `password`, `login_type`, `ip_address`, `ip_source`, `create_time`, `update_time`, `last_login_time`) VALUES (995, 1005, 'xiaainy@163.com', '$2a$10$K7KQJ8mED4NKLvaNlAOx5ey4NbcU1CUDrEJnL9zCWNIvnbjrhwOnK', 1, '61.222.202.239', '台湾省', '2022-01-27 10:58:11', '2022-01-27 10:58:12', '2022-01-27 10:58:12');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_user_info` (`id`, `email`, `nickname`, `avatar`, `intro`, `web_site`, `is_disable`, `create_time`, `update_time`) VALUES (1, 'admin@qq.com', '管理员', 'https://static.talkxj.com/avatar/user.png', 'admin@qq.com', NULL, 0, '2021-08-12 15:43:17', '2021-08-12 15:51:42');
INSERT INTO `tb_user_info` (`id`, `email`, `nickname`, `avatar`, `intro`, `web_site`, `is_disable`, `create_time`, `update_time`) VALUES (1005, 'xiaainy@163.com', '用户1486533968342859778', 'https://static.talkxj.com/config/2cd793c8744199053323546875655f32.jpg', NULL, NULL, 0, '2022-01-27 10:58:11', NULL);
COMMIT;
...
CREATE TABLE `tb_user_role` (
  ...
  `role_id` int DEFAULT NULL COMMENT '角色id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1003 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of tb_user_role
-- ----------------------------
BEGIN;
INSERT INTO `tb_user_role` (`id`, `user_id`, `role_id`) VALUES (1001, 1, 1);
INSERT INTO `tb_user_role` (`id`, `user_id`, `role_id`) VALUES (1002, 1005, 2);
COMMIT;
